...
Moving agent tooling from \`.agents/\` to \`/.agents/\` simplifies the multi-agent merge process:
...
- Move .agents/ to /.agents/ for simpler multi-agent merges
