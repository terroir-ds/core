...
- **accessibility**: Patterns ensuring inclusive design
- **maintainability**: Patterns that improve code maintenance
- **testability**: Patterns that make testing easier
- **testing**: Patterns about testing practices and coverage
- **documentation**: Patterns about documentation itself
- **quality-control**: Patterns ensuring quality standards
...
- **infrastructure**: DevOps and system patterns
...
4. Add complexity tag for learning paths
...
- Document tag additions in this file
...
4. `meta-pattern` - 2 patterns (pattern-quality-scoring, standard-quality-scoring)
5. `standards` - 1 pattern (standard-quality-scoring)
6. `security` - 1 pattern (standard-quality-scoring)
7. `testing` - 1 pattern (standard-quality-scoring)
<!-- END AUTO-GENERATED -->
...
- `integration`: For third-party integration patterns
