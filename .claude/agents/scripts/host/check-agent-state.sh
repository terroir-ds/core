...
if [ -f ".devcontainer/devcontainer.json" ]; then
    if [ -f "/workspaces/terroir-core/.claude/agents/templates/devcontainer.json" ]; then
        if ! diff -q .devcontainer/devcontainer.json /workspaces/terroir-core/.claude/agents/templates/devcontainer.json >/dev/null; then
